...
| `Ekstrom_2017_PEPI.pdf` | Ekström (2017), *PEPI*, doi:10.1016/j.pepi.2017.07.010 | Short-period extension of the same method; grounds the resolution-bandwidth argument in Notebook 4. |
...
| `Xue_Olugboji_2025_AkiNet_JGRMLC.pdf` | Xue & Olugboji (2025), *JGR: Machine Learning and Computation*, doi:10.1029/2025JH000932 | Motivates the additive phase-velocity corridor (`build_template_family`'s ±0.8 km/s window) and the "defaults to reference" diagnostic framing used in Notebook 4's quality discussion. |
