function [saved_ccf_path] = ccf_compute_crosscorr_mtc_Z(ccf_data_file,path_vars,parameters,stacktype,filttype)
    ...
    clear N1 N2
    %S1_data_mat_2D=[S1_data_mat_2D, zeros(size(S1_data_mat_2D,1),7808)];
    %S2_data_mat_2D=[S2_data_mat_2D, zeros(size(S2_data_mat_2D,1),7808)];
