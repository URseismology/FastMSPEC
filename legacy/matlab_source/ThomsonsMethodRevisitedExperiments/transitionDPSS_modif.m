function [S,lambda,lambda_all,lowerindex,upperindex] = transitionDPSS_new(N,W,epsilon,cutoff)
%% transitionDPSS.m 
...
while(flag)
    ...
    for j = 1:(k(2)-k(1)+1),
     ...
     % warning(message('transitionDPSS:DPSS', j+k(1)-1));
       ...
       e = interp1(x,e,xnew,'spline');
       S1b(:,idx+j) = e/sqrt(sum(squared(e)));
