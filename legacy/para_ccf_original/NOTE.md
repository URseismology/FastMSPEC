...
`a1_ccf_ambnoise_RTZ_NE_Para.m` in particular is the direct ancestor of the later
`a1_ccf_ambnoise_RTZ_NE_ADAMA.m` script found in the lab's more recent codebase snapshot (which
