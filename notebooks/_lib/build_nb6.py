"""Builds 06_coda_correlation_future_work.ipynb from scratch via nbformat.
This is a roadmap/scaffold notebook, not a full implementation -- see the
original plan's Notebook 4 section for why (renumbered to 06 in the
2026-09-08 notebook restructuring -- see docs/notebook5_revamp_progress.md
-- to make room for the phase-velocity/dispersion-curve work at 04)."""
...
md(r"""# Notebook 6 — Future Work: Coda-Correlation
...
with open('06_coda_correlation_future_work.ipynb', 'w') as f:
    nbf.write(nb, f)
print("wrote 06_coda_correlation_future_work.ipynb with", len(cells), "cells")
